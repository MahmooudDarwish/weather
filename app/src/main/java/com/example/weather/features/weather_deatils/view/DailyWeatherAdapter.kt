...
class FavoriteDailyWeatherAdapter(
    private var weatherList: List<DailyWeatherEntity?>,
    private val onDayClickListener: OnDayClickedFavorite,
    private val temperatureUnit: Temperature,
    private val context: Context
) : RecyclerView.Adapter<FavoriteDailyWeatherAdapter.DayViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DayViewHolder, position: Int) {
        ...
        if (weatherItem != null) {
            ...
            holder.itemView.setOnClickListener {
                ...
                onDayClickListener.onDayClicked(weatherItem)
            }
        }
